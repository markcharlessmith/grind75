...
var minimumAbsDifference = function (arr) {
  // edge case handling
  if (arr.length >= 10 ** 5 || arr.length <= 2) return 'invalid array length';
...
console.log(minimumAbsDifference([-10000007, 1, 2])); // expect 'invalid array element'
